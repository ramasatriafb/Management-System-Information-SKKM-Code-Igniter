      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Workshop & Seminar</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                 <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/isi_mahasiswa_workshop_seminar'); ?>"class="btn btn-success btn-primary">Isi Mahasiswa Peserta Workshop & Seminar</a></td></tr></div>
                 ...
                 <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <?php 
                    $no=0;
                      if(isset($workshop_seminar)){ 
                      foreach($workshop_seminar as $data){ 
