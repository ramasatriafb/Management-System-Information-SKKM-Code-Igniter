          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/deskripsi_mawapres'); ?>"class="btn btn-warning btn-primary">Tambah Deskripsi </a></td></tr></div>
                 <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/isi_mahasiswa_mawapres'); ?>"class="btn btn-success btn-primary">Isi Mahasiswa </a></td></tr></div>
                 <div class="col-xs-2"><tr><td><a href="<?php echo site_url('super_administrator/rekap_mawapres'); ?>"class="btn btn-danger btn-primary">Rekap Mahasiswa MAWAPRES</a></td></tr></div>
              </div><!-- /.box-header -->
                 <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <?php echo $data['JENIS_KEGIATAN']; ?> </td>
                      <td> <a href="update_mawapres/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-edit"></i> </a> | <a href="delete_mawapres/<?php echo $data['ID']; ?>"onClick="return doconfirm();">
