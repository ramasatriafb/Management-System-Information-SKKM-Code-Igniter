      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Kegiatan Kepesertaaan</a></li>
            <li><a href="#">PKM</a></li>
            <li class="active">Tambah PKM</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah MAWAPRES</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("super_administrator/submit_mawapres"); ?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Kegiatan</label>
                      <input name="nama" class="form-control" type="text" list="nama_list" required />
                      <datalist id="nama_list">
                    <?php foreach($mawapres as $each)
                      {
                          ?>
