      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">MAWAPRES</a></li>
            <li class="active">Edit MKEgiatan MAWAPRES</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit MAWAPRES</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                 <?php foreach ($hasil as $data) {           ?>
                <?php echo form_open('super_administrator/update_mawapres/'.$data['ID']);  ?>
                  <div class="box-body">
