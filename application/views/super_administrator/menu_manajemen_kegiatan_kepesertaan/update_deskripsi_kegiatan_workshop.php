      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Update Deskripsi Kegiatan Workshop & Seminar</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Deskripsi Kegiatan Workshop & Seminar Mahasiswa</h3>
                </div><!-- /.box-header -->
              <div class="box-body">
                     <!-- form start -->
                      <?php foreach ($hasil as $data) {           ?>
                <?php echo form_open('super_administrator/update_deskripsi_kegiatan_workshop_seminar/'.$data['ID']);  ?>
