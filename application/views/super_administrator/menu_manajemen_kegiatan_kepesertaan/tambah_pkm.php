            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah PKM</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("super_administrator/submit_pkm"); ?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Kegiatan</label>
                      <input name="nama" class="form-control" type="text" list="nama_list" required />
                      <datalist id="nama_list">
                    <?php foreach($pkm as $each)
                      {
                          ?>
                   ...
                   <div class="form-group">
                      <label for="exampleInputEmail1">Pilih Kategori PKM</label>
                        <select name = "kategori_pkm"class="form-control select2" style="width: 100%;">
                     <?php foreach($kategori_pkm as $each)
                      {
                          ?>
