      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Deskripsi Kegiatan Wirausaha</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box-header">
                 <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/isi_mahasiswa_wirausaha'); ?>"class="btn btn-success btn-primary">Isi Mahasiswa Peserta Wirausaha</a></td></tr></div>
              <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/rekap_wirausaha'); ?>"class="btn btn-danger btn-primary">Rekap Mahasiswa Peserta Wirausaha</a></td></tr></div>
              </div><!-- /.box-header -->
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Detail Deskripsi Wirausaha</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("super_administrator/submit_deskripsi_kegiatan_wirausaha"); ?>
                  <div class="box-body">
                    ...
                    <?php foreach($nama_kegiatan_perlombaan as $each)
                      {
                          ?>
                ...
                <div class="box-header">
                 ...
                 <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <a href="detail_deskripsi_kegiatan_wirausaha/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-desktop"></i> </a> | <a href="update_deskripsi_kegiatan_wirausaha/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-edit"></i> </a> | <a href="delete_deskripsi_kegiatan_wirausaha/<?php echo $data['ID']; ?>"onClick="return doconfirm();">
