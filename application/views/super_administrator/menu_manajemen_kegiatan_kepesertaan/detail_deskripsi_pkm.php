      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Detail Deskripsi Kegiatan PKM</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Detail Deskripsi Kegiatan Kepesertaan PKM Mahasiswa</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
             <?php foreach ($deskripsi as $deskripsii) {           ?>
                    ...
                    <div class="form-group">
                    <label>Kategori PKM</label>
                    <span><?php echo $deskripsii['KATEGORI_PKM']; ?></span>
                    </select>
                    </div>
                    <div class="form-group">
