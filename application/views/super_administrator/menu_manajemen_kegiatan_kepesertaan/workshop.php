      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Deskripsi Kegiatan Workshop & Seminar</li>
          </ol>
        </section>
        <section class="content">
          <div class="row">
            ...
            <div class="box-header">
                     <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/isi_mahasiswa_workshop_seminar'); ?>"class="btn btn-success btn-primary">Isi Mahasiswa </a></td></tr></div>
              <div class="col-xs-3"><tr><td><a href="<?php echo site_url('super_administrator/rekap_workshop_seminar'); ?>"class="btn btn-danger btn-primary">Rekap Mahasiswa Peserta Workshop & Seminar</a></td></tr></div>
             </div><!-- /.box-header -->
              <!-- general form elements -->
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Detail Deskripsi Workshop & Seminar</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("super_administrator/submit_deskripsi_kegiatan_workshop_seminar"); ?>
                  <div class="box-body">
                    ...
                    <?php foreach($nama_kegiatan_workshop_seminar as $each)
                      {
                          ?>
                    ...
                    <div class="input-group">
                     ...
                     <div class="form-group">
                      <label for="exampleInputEmail1">Pilih Poin</label>
                        <select name = "tingkat_poin_id"class="form-control select2" style="width: 100%;">
                ...
                <div class="box-header">
                 ...
                 <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <a href="detail_deskripsi_kegiatan_workshop_seminar/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-desktop"></i> </a> | <a href="update_deskripsi_kegiatan_workshop_seminar/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-edit"></i> </a> | <a href="delete_deskripsi_kegiatan_workshop_seminar/<?php echo $data['ID']; ?>"onClick="return doconfirm();">
