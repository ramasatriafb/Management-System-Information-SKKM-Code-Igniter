      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Isi Mahasiswa Kegiatan Wajib</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Isi Mahasiswa Kegiatan Wajib</h3>
                </div><!-- /.box-header -->
              <div class="box-body"> <?php echo form_open("super_administrator/submit_mahasiswa_wajib"); ?>
