      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Kegiatan Wajib</a></li>
            <li class="active">Tambah Kegiatan Wajib</li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah Kegiatan Wajib</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("super_administrator/submit_kegiatan_wajib"); ?>
                   <div class="box-body">
                    <div class="form-group">
                      <label>Nama Kegiatan</label>
                      <input name="nama" class="form-control" type="text" list="nama_list" required />
                      <datalist id="nama_list">
                    <?php foreach($kegiatan_wajib as $each)
                      {
                          ?>
                    ...
                    <div class="form-group">
                      ...
                      {
                          ?>
                          <option value="<?=$each['ID']?>"><?php echo ' Jenis '?><?=$each['JENIS_KEGIATAN']?></option>
                          <?php
                      }
                      ?>?>
                    </select>
