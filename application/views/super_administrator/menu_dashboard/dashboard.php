          ...
          <div class="col-xs-12">
           <div class="box box-primary">
                <div class="box-header with-border">
                 <div class="box-body"> <?php echo form_open("super_administrator/cari_tahun"); ?>
                  <div class="form-group">
                    <label>Pilih Tahun Kegiatan</label>
                     <select name = "tahun" class="form-control select2" style="width: 50%;">
                     <?php foreach($tahun as $each)
                      {
                          ?>
                          <option value="<?=$each['TAHUN']?>"><?=$each['TAHUN']?></option>
                          <?php
                      }
                      ?>?>
                    </select>
                 ...
                 <i class="fa fa-bar-chart-o"></i>
                  <h3 class="box-title">Keaktifan Mahasiswa Mengikuti Kegiatan Tahun <?php echo $now;?> </h3>
