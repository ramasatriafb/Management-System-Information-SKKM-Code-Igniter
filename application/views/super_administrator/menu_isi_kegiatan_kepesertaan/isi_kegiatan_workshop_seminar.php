      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Isi Mahasiswa Workshop & Seminar</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Isi Mahasiswa Peserta Workshop & Seminar</h3>
                </div><!-- /.box-header -->
              <div class="box-body"> <?php echo form_open("super_administrator/submit_mahasiswa_workshop_seminar"); ?>
                  ...
                  <input name="nomor_sk" class="form-control" type="text" list="nomor_list" required />
                    ...
                    <button id="cari" type="submit" class="btn btn-primary"><i class=" fa fa-fw fa-search"></i></button>
                    </div>
