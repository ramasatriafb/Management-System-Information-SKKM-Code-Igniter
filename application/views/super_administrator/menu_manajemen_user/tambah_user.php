          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <?php echo form_open("super_administrator/submit_tambahuser"); ?>
          
                  <div class="box-body">
                    <div class="form-group">
                    <label>Pilih Pegawai</label>
                    <select name = "email_pegawai"class="form-control select2" style="width: 100%;">
                    ...
                    <select name="hak_akses"class="form-control select2" style="width: 100%;">
                      <option value ="1"selected="selected">Super Administrator</option>
