            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Atur Batas Waktu Aktifitas Input Data Pada Sistem</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                
                <<?php foreach ($hasil as $data) {           ?>
                <?php echo form_open('super_administrator/update_batas_waktu/'.$data['ID']);  ?>
          
                  <div class="box-body">
                     <div class="form-group">
                    <label>Tanggal Mulai:</label>
                    <span><?php echo $data['TGL_AWAL']; ?></span>
                    ...
                    <span><?php echo $data['TGL_AKHIR']; ?></span>
                    <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
