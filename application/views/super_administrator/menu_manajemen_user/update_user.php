          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <?php echo form_open('super_administrator/update_user/'.$data['ID']);  ?>
          
                  <div class="box-body">
                    <div class="form-group">
                    <label>Pilih Pegawai</label>
                    <select name = "email_pegawai"class="form-control select2" style="width: 100%;" disabled>
                     <?php foreach($pegawai as $each)
                      {
                          ?>
                          <option value="<?=$each['EMAIL']?>"><?=$each['NAMA']?></option>
                          <?php
                      }
                      ?>?>
                    </select>
                    ...
                    <select name="hak_akses"class="form-control select2" style="width: 100%;">
                       <option <?php if($data['KODE_AKSES']=='1') echo "selected=selected"; ?> value = "1">Super Administrator</option>
                      <option <?php if($data['KODE_AKSES']=='2') echo "selected=selected"; ?> value = "2">Administrator</option>
                      </select>
                    </div>
                  </div><!-- /.box-body -->
