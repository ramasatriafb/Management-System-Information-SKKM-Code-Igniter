            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <label>Poin Minimum Diploma 3 :</label>
                      <span> <h2><?php foreach ($minimum_poin as $data) echo $data['MINIMUM_POIN_D3'];?></h2></span>
                  </div>
                  <div class="form-group">
                  <label>Poin Minimum Diploma 4 :</label>
                      <span>  <h2><?php foreach ($minimum_poin as $data) echo $data['MINIMUM_POIN_D4'];?></h2></span>
                  </div>
                   <?php echo form_open("super_administrator/submit_minimum_poin"); ?>
                   <div class="form-group">
                      <label>Atur Poin Minimum Diploma 3</label>
                      <input type="text" class="form-control" name="poind3">
                    </div>
                   <div class="form-group">
                      <label>Atur Poin Minimum Diploma 4</label>
                      <input type="text" class="form-control" name="poind4">
                    </div>
                  ...
                  <div class="col-xs-2"><tr><td><a href="<?php echo site_url('super_administrator/tambah_jenis_poin'); ?>"class="btn btn-block btn-primary">Tambah</a></td></tr></div>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    $no=$no+$hal;
                      if(isset($tabel_poin)){ 
                      foreach($tabel_poin as $data){ 
                      
                      $no++;
                      ?>
                      <tr>
                    <td> <?php echo $no; ?> </td>
                    <td> <?php echo $data['KODE_PARTISIPASI']; echo '-';echo $data['KODE_LINGKUP'];?> </td>
                    <td> <?php echo $data['TINGKAT_PARTISIPASI']; ?> </td>
                    <td> <?php echo $data['LINGKUP_KEGIATAN']; ?> </td>
                    <td> <?php echo $data['POIN']; ?> </td>
                    <td> <a href="update_poin/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-edit"></i> </a> | <a href="delete_poin/<?php echo $data['ID']; ?>"onClick="return doconfirm();">
