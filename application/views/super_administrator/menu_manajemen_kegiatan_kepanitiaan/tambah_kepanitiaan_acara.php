      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Kepanitiaan Acara</a></li>
            <li class="active">Tambah Kepanitiaan Acara</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah Kepanitiaan Acara</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("super_administrator/submit_kepanitiaan_acara"); ?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Kegiatan</label>
                     <input name="nama" class="form-control" type="text" list="panitia_list" required />
                      <datalist id="panitia_list">
                    <?php foreach($panitia as $each)
                      {
                          ?>
