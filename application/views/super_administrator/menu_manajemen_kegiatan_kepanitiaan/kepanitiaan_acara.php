      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Kepanitiaan Acara</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <div class="col-xs-2"><tr><td><a href="<?php echo site_url('super_administrator/tambah_kepanitiaan_acara'); ?>"class="btn btn-block btn-primary">Tambah</a></td></tr></div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <a href="update_kepanitiaan_acara/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-edit"></i> </a> | <a href="delete_kepanitiaan_acara/<?php echo $data['ID']; ?>"onClick="return doconfirm();">
