            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <div class="col-xs-2"><tr><td><a href="<?php echo site_url('super_administrator/tambah_organisasi_mahasiswa'); ?>"class="btn btn-block btn-primary">Tambah</a></td></tr></div>
                </div><!-- /.box-header -->
                 <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <?php echo $data['JENIS_KEGIATAN']; ?> </td>
                     <td> <?php if($data['STATUS_KEGIATAN'] == 'Aktif') echo '<i align ="center" class="fa fa-fw fa-check"></i>';else if($data['STATUS_KEGIATAN'] == 'Tidak Aktif') echo '<i class="fa fa-fw fa-ban"></i>'; ?> </td>
