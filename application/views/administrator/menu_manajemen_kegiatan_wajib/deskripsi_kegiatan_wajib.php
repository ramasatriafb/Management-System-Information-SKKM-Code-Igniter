      ...
      <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Deskripsi Kegiatan Wajib</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Detail Deskripsi Kegiatan Wajib Mahasiswa</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open("administrator/submit_deskripsi_kegiatan_wajib"); ?>
                  <div class="box-body">
                    <div class="form-group">
                    <label>Pilih Nama Kegiatan</label>
                    <select name = "nama"class="form-control select2" style="width: 100%;">
                     <?php foreach($nama_kegiatan_wajib as $each)
                      {
                          ?>
                    ...
                    <div class="input-group">
                      ...
                      <input type="date"name="tgl_mulai" class="form-control" value="dd/mm/yyyy"data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                   <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="date" name="tgl_akhir"class="form-control" value="dd/mm/yyyy"data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                    </div><!-- /.input group -->
                     <div class="form-group">
                ...
                <div class="box-header">
                 ...
                 <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <a href="detail_deskripsi_kegiatan_wajib/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-desktop"></i> </a> | <a href="update_deskripsi_kegiatan_wajib/<?php echo $data['ID']; ?>"><i class="fa fa-fw fa-edit"></i> </a> | <a href="delete_deskripsi_kegiatan_wajib/<?php echo $data['ID']; ?>"onClick="return doconfirm();">
